...
import Filtrar from "../../assets/img/filtro.png";
...
const Main = () => {
  ...
  const body = (
    <div className={styles.modal}>
      <button className={styles.button1} onClick={() => OpenAndCloseModal()}>
        x
      </button>
    ...
    <Router>
      <Fragment>
        <main className="Main">
          ...
          <Modal open={modal} onClose={OpenAndCloseModal}>
            {body}
          </Modal>
        </main>
      </Fragment>
